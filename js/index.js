...
function checkOverLapping(coordinates){
...
function gameEngine(){
    ...
    if(isCollide(snakeArr)){
        score = 0; 
        const currScore = document.getElementById('scoreBox');
    ...
    if(snakeArr[0].y === food.y && snakeArr[0].x ===food.x){
        ...
        while(checkOverLapping(newFood)){
...
window.addEventListener('keydown', e =>{
    ...
    moveSound.play();
    if(e.key === "ArrowUp" && previousKey !== "ArrowDown"){
        previousKey = "ArrowUp";
        performKeyPress(e.key);
    }
    else if(e.key == "ArrowDown" && previousKey !== "ArrowUp"){
        previousKey = "ArrowDown";
        performKeyPress(e.key);
    }
    else if(e.key == "ArrowLeft" && previousKey !== "ArrowRight"){
        previousKey = "ArrowLeft";
        performKeyPress(e.key);
    }
    else if(e.key == "ArrowRight" && previousKey !== "ArrowLeft"){
